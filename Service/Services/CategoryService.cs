...
namespace Service.Services
{
    public class CategoryService : Service<Category>, ICategoryService
    {
        ...
        public CategoryService(IUnitOfWork unitOfWork, IGenericRepository<Category> repository, IMapper mapper, CategoryRepository categoryRepository) : base(unitOfWork, repository)
        {
            _mapper = mapper;
